...
router.post(
  "/",
  validateRequestBody(itemskillsSchemas.createItemSkillsSchema),
  itemskillsController.create,
);
router.put(
  "/:id",
  validateRequestBody(itemskillsSchemas.updateItemSkillsSchema),
  itemskillsController.update,
);
