...
// write methods --------------------------------------------------------------
router.post('/', validateRequestBody(effecttargetSchemas.createEffectTargetSchema), effecttargetController.create);
router.put('/:id', validateRequestBody(effecttargetSchemas.updateEffectTargetSchema), effecttargetController.update);
