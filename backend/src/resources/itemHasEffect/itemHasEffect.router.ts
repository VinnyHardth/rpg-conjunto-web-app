...
// write methods --------------------------------------------------------------
router.post('/', validateRequestBody(itemhaseffectSchemas.createItemHasEffectSchema), itemhaseffectController.create);
router.put('/:id', validateRequestBody(itemhaseffectSchemas.updateItemHasEffectSchema), itemhaseffectController.update);
