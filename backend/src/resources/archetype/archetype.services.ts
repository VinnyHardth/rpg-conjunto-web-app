...
import { CreateArchetypeDTO, UpdateArchetypeDTO, ArchetypeDTO } from './archetype.types';

const prisma = new PrismaClient();

const createArchetype = async (data: CreateArchetypeDTO): Promise<ArchetypeDTO> => {
...
const updateArchetype = async (id: string, data: UpdateArchetypeDTO): Promise<ArchetypeDTO> => {
