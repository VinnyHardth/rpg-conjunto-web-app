...
// write methods --------------------------------------------------------------
router.post('/', validateRequestBody(archetypeSchemas.createArchetypeSchema), archetypeController.create);
router.put('/:id', validateRequestBody(archetypeSchemas.updateArchetypeSchema), archetypeController.update);
