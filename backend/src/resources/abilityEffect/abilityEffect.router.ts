...
// write methods --------------------------------------------------------------
router.post('/', validateRequestBody(abilityeffectSchemas.createAbilityEffectSchema), abilityeffectController.create);
router.put('/:id', validateRequestBody(abilityeffectSchemas.updateAbilityEffectSchema), abilityeffectController.update);
