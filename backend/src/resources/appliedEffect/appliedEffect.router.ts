...
// write methods --------------------------------------------------------------
router.post('/', validateRequestBody(appliedeffectSchemas.createAppliedEffectSchema), appliedeffectController.create);
router.put('/:id', validateRequestBody(appliedeffectSchemas.updateAppliedEffectSchema), appliedeffectController.update);
